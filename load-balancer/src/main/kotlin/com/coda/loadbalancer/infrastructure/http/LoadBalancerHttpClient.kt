package com.coda.loadbalancer.infrastructure.http
 ...
 * Tracing is handled by OpenTelemetry agent automatically.
 */
            ...
            try {
                ...
                val latency = measureTime {
                    val response = client.request(url) {
                        ...
                        propagator.inject(Context.current(), this) { carrier, key, value ->
                ...
                ForwardResult.Success(responseStatus, latency)
...
sealed interface ForwardResult {
    data class Success(val statusCode: Int, val latency: Duration) : ForwardResult
